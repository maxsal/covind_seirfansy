...
date_15_March= which(data$date == "15-Mar-20")
date_31_dec = which(data$date == "31-Dec-20")
data_initial = data[date_15_March, ]
data_train = data[date_15_March:date_31_dec, ]
